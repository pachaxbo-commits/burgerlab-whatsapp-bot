...
- Si hay un pedido en curso y el mensaje nuevo es SOLO una pregunta (por ejemplo "En q tiempo?"), responde unicamente la pregunta con intent="question" e items=[]. NO reconstruyas, dividas, sumes, quites ni repitas el pedido. El borrador mostrado abajo es contexto de memoria, no una instruccion para volver a procesarlo.
- Para preguntas de tiempo de preparacion responde que tarda aproximadamente de 15 a 20 minutos y que se avisara apenas este listo.
...
- Los nombres visibles del catalogo pueden haberse abreviado con el tiempo. Usa principalmente el id y las caracteristicas del producto (marca BBQ/Burger Lab, simple/doble y con/sin papas); un cambio menor de nombre nunca debe borrar ni convertir un item que ya estaba en el borrador.
